...
//console.log(arrows) üst tarafda yazdığımız kodla html deki arrowslara ulaşabildikmi denetlemede yazılı console kısmında .ıktısı görülür
...
//!DARK Mode
//const item = document.querySelectorAll(".container,.sidebar,.sidebar i,.navbar,.toggle-ball,.profile-text-container i,.profile-text-container a,.movie-list-filter select,.toggle,.toggle-ball")
